...
# # kevin a - 4, aa - 1, aan - 1, aana - 1, aanan - 1, aanana - 1, aananas - 1

# ----------------------------------------------------------------------------------------------------------

# ANOTHER BROKEN MINION GAME
...
def get_stuart_score(string):
    ...
    while i < length:
        substring = string[i]
        if string[i] in consonants:  # if consonant
            score += length - i
        i += 1
    return score
...
def get_kevin_score(string):
    ...
    while i < length:
        substring = string[i]
        if string[i] in vowels:  # if consonant
            score += length - i
        i += 1
    return score
